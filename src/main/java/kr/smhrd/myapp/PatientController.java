...
import kr.smhrd.model.AnswerVO;
import kr.smhrd.model.MemberVO;
import kr.smhrd.model.PatientpointVO;
import kr.smhrd.model.PatientsDAO;
import kr.smhrd.model.PatientsVO;
...
public class PatientController {
	...
	public String study(Model model) {
		 ...
		 application.setAttribute("sinfo", studyinfo);
	      ...
	      int ans_num = 1/*patlog.get(0).getPat_num()+1*/;
	      int pat_round = patlog.get(0).getPat_round();
	      patlog.get(0).setPat_num(ans_num);
	      ...
	      model.addAttribute("pat_num",ans_num);
	...
	public String allGraph(Model model){
		...
		System.out.println("2번회원");
		System.out.println(allinfo.get(0).getPp_date());
		System.out.println("0번총점"+allinfo.get(0).getTotalpoint());
		
		System.out.println("1번회원");
		
		/*System.out.println(allinfo.get(1).getPp_date());
		System.out.println("1번총점"+allinfo.get(1).getTotalpoint());*/
